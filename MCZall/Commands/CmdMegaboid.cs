...
namespace MCZall
{
    public class CmdMegaboid : Command
    {
        ...
        {
            if (p.megaBoid == true) { p.SendMessage("You may only have on Megaboid going at once. Use /abort to cancel it."); return; }
        ...
        {
            p.SendMessage("/megaboid [type] <solid/hollow/walls/holes> - create a cuboid of blocks.");
        }
